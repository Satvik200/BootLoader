...
boot:
	...
	int 0x13                        ; BIOS interrupt call to read sector
...
msg: db "32-bit BootLoader with no 512 bytes limit loaded successfully...", 0  ; Define the message to be printed, null-terminated
...
.loop:
	...
	or eax, 0x0E00                  ; Set the high byte of EAX to 0x0E (attribute for yellow text color)
...
times 1024 - ($-$$) db 0            ; Fill the rest of the boot sector with zeros
